...
create table if not exists envelopes (
  ...
  projected_amount numeric(14,2) not null default 0, -- teto opcional acima do valor fixo (ex: condomínio com taxa extra)
...
-- ---------------------------------------------------------------------
-- push_subscriptions — inscrições de notificação push (Web Push) por
-- dispositivo/navegador. A Edge Function usa a service role key pra ler
-- todas (ignora RLS); o app só enxerga/apaga a própria.
-- ---------------------------------------------------------------------
